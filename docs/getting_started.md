...
This guide shows the recommended v1.0.16 workflow. Start from a schema-bound template, generate a project JSON, build outputs through the project command, and verify the build manifest.
