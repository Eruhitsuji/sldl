...
Generated from the bundled template manifest. In v1.0.10, release checks keep the template and diagnostics reference drift checks and also drift-check the reference index and CLI help reference.
