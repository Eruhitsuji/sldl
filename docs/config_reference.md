...
Records the generated diagnostics-code reference used by v1.0.12 release checks.
...
Records paths, kinds, and SHA-256 hashes for generated static reference documents. It is drift-checked by the v1.0.12 release gate.
...
Records static CLI help generated from the implemented argument parser. It is drift-checked by the v1.0.12 release gate.
