...
v1.0.3では、英語版ドキュメントを主参照とし、日本語版ドキュメントを補助的な利用ガイドとして提供します。また、テンプレートとschemaの紐づけ検査、template explain、document type不整合診断、template explainのMarkdown/JSON出力、manifest互換性検査を追加しています。
...
- `template_schema_binding.md`: v1.0.3のtemplateとschemaの紐づけ、manifest互換性、および診断。
