...
v1.0.13では、英語版ドキュメントを主参照とし、日本語版ドキュメントを補助的な利用ガイドとして提供します。template-first workflowとschema-template診断を維持しつつ、診断コード、reference index、CLI help referenceを自動生成・drift checkできるようにしています。
