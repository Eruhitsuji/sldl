...
v1.0.16では、英語版ドキュメントを主参照とし、日本語版ドキュメントを補助的な利用ガイドとして提供します。template-first workflowとschema-template診断を維持しつつ、診断コード、reference index、CLI help referenceを自動生成・drift checkできるようにしています。
...
8. `docs/ci_workflow.md` または `docs/ja/ci_workflow.md`
...
- `v1_0_13_release_notes.md`: v1.0.13リリースノート。
- `v1_0_14_release_notes.md`: v1.0.14リリースノート。
- `v1_0_15_release_notes.md`: v1.0.15リリースノート。
- `v1_0_16_release_notes.md`: v1.0.16リリースノート。
- `ci_workflow.md`: GitHub ActionsとCI release checkの説明。
...
- `release_report.md`: 生成済みrelease report。
- `release_summary.json`: 生成済みCI release summary。
