...
v1.0.8では、英語版ドキュメントを主参照とし、日本語版ドキュメントを補助的な利用ガイドとして提供します。template-first workflowを維持しつつ、schema missing、config_type mismatch、template file missingなどの失敗時診断を強化しています。
