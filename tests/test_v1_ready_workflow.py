...
def test_v115_readme_and_getting_started_are_template_first():
...
def test_v115_commands_reference_documents_template_docs_checks():
...
def test_v115_project_workflow_and_examples_document_template_provenance():
